                        ...
                        <div>
                            <NumberInput
                                ...
                                :label="
                                    breakpoints.isSmaller('lg')
                                        ? t(
                                              `calculators.food_waste.messages.paper_packaging_amount`
                                          )
                                        : ''
                                "
                                :min="0"
                        ...
                        <div>
                            <NumberInput
                                ...
                                :label="
                                    breakpoints.isSmaller('lg')
                                        ? t(
                                              `calculators.food_waste.messages.plastic_packaging_amount`
                                          )
                                        : ''
                                "
                                :min="0"
            ...
            <div>
                <span v-if="!results">
                    ...
                    <span v-else-if="loading"
                        >{{ t('calculators.shared_messages.calculating') }}.</span
                    >
                    <span v-else>{{
